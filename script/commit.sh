...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/CloudQuickLabsADO/_git/GitHubToADOSync.git
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/CloudQuickLabsADO/_git/GitHubToADOSync.git